export const products = [
  { 
    id: 1, 
    name: 'Neumático EAGLE F1 ASYMMETRIC', 
    price: 199.99, 
    image: 'https://s1.medias-norauto.es/images_produits/tyre_comm_txt-goodyear_eagle_f1_asymmetric_6-1/900x900/neumatico-goodyear-eagle-f1-asymmetric-6-215-60-r18-102-w-xl-mo--2844792.jpg', 
    brand: 'Goodyear', 
    type: 'Neumático', 
    category: 'Deportivo',
    description: 'Neumático de verano de ultraalto rendimiento diseñado para coches con atributos deportivos.',
    rating: 4.5,
    tag: null,
  ...
  { 
    ...
    price: 249.99, 
    image: 'https://http2.mlstatic.com/D_NQ_NP_714072-MLM72223129768_102023-O.webp', 
    brand: 'Goodyear', 
    type: 'Neumático', 
